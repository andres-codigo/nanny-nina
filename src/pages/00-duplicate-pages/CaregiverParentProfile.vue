	...
	<div class="w-full">
		...
		<main>
			<div class="h-full flex flex-col pb-40">
				<ProfileCarousel class="mb-4" />

				<div class="mx-4">
					<h5 class="text-header-five font-semibold antialiased mt-4 mb-2">Meet Brittany</h5>
			...
			<section class="block fixed inset-x-0 w-full bottom-0 z-10 bg-white border-t border-gray">
				<FixedBottomBookingMatch title="€16-18/hr" buttonPrimaryText="Apply" />
			</section>
		</main>
	</div>
</template>
...
import Requirements from '../../components/profile/view/Requirements.vue'
...
import { ChevronLeftIcon, DotsVerticalIcon, ClockIcon } from '@heroicons/vue/solid'
