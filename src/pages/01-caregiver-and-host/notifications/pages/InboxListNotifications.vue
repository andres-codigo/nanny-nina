	...
	<div class="w-full h-full">
		...
		<main>
			...
			<div class="flex flex-col">
				<InboxNotificationItem :isNewNotification="true" />
				<InboxNotificationItem src="./assets/svg/notifications/circle-green-heart-purple.svg" :isNewNotification="true">
				...
				<InboxNotificationItem src="./assets/svg/notifications/circle-green-sticky-note-purple.svg">
					<template #notificationMessage>
						<p class="antialiased">Monthly Check up</p>
						<p class="text-xs text-gray-500">31/11/2021, 16:30</p>
					</template>
				</InboxNotificationItem>
				<InboxNotificationItem src="./assets/svg/notifications/circle-green-info-purple.svg">
					<template #notificationMessage>
				...
				<InboxNotificationItem src="./assets/svg/notifications/circle-green-verified-purple.svg">
					<template #notificationMessage>
						<p class="antialiased">Whoop! You just got a match! Take a look</p>
						<p class="text-xs text-gray-500">31/11/2021</p>
					</template>
				</InboxNotificationItem>
				<InboxNotificationItem src="./assets/svg/notifications/circle-green-local-offer-purple.svg">
					<template #notificationMessage>
				...
				<InboxNotificationItem src="./assets/svg/notifications/circle-green-thumbs-up-purple.svg" :isLastNotificationItem="true">
					<template #notificationMessage>
