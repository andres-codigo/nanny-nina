		...
		<main>
			<div class="min-h-screen flex flex-col justify-center pt-12 mx-4">
				...
				<div class="inline-flex pb-8">
					<LinkCard to="dashboard" class="text-purple-900 bg-green-500 hover:shadow-lg hover:shadow-gray-50 focus:bg-green-600" title="Sign up as Parent/Host" >
						<template #details><p>Request Nanny, Childminder or Au pair</p></template>
					</LinkCard>
				</div>
				<div class="inline-flex pb-8">
					<LinkCard to="dashboard" class="text-white bg-purple-500 hover:shadow-lg hover:shadow-gray-300 focus:bg-purple-600" title="Sign up for Care jobs">
