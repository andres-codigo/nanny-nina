	...
	<div>
		...
		<main>
			...
			>
				...
				<div class="pt-6">
					<CarouselHeader title="Fully insured," />
					<CarouselHeader title="You're safer with us" />
					<Paragraph
						content="Working at Nanny Nina means that you're fully covered incase of accidents or unforeseen incidents while you work"
					/>
				</div>
