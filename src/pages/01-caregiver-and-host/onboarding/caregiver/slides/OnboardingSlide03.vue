	...
	<div>
		...
		<main>
			...
			>
				...
				<div class="pt-6">
					<CarouselHeader title="Safe and" />
					<CarouselHeader title="Quickest payout" />
					<Paragraph
						content="Get paid within 24hrs of job completion via the app.  We ensure that all our nannies are secure."
					/>
				</div>
