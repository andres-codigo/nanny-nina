	...
	<div>
		...
		<main>
			...
			>
				...
				<div class="pt-6">
					<CarouselHeader title="No need for" />
					<CarouselHeader title="negotiations" />
					<Paragraph
						content="We ensure safe and secure payment of all our partners, So you don't have to stress about it"
					/>
				</div>
