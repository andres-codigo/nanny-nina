				...
				<div class="flex flex-col mx-4">
					<div class="flex flex-col pt-6">
						...
						<p class="font-light antialiased">
							Please download &amp; check all the boxes in the
							awareness form template
						</p>
					</div>

					<div
						class="flex flex-col justify-center items-center mt-6 mb-10"
					>
						<ButtonOutlineDark
							classes="inline-flex items-center w-button-280px h-10 text-sm leading-5 py-2"
						>
							<template #iconWithText>
								<ImageComponent
									class="w-5 h-5"
									src="./assets/svg/other/download-black.svg"
									alt=""
								/>
								<span class="pl-2">Download template</span>
							</template>
						</ButtonOutlineDark>
					</div>
					...
					<div class="flex flex-col mt-6">
						<SinglePhotoUpload
							title="Upload Picture/PDF"
							description="Please upload your filled awareness form here."
						/>
					</div>
