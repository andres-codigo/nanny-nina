		...
		<main>
			<div class="h-full flex flex-col mx-4 mb-10">
				<div class="mt-16 mx-12">
					<h2
						class="font-semibold text-header-two text-center antialiased mb-6"
					>
						Congrats!<br />
						You have applied to the Sanders!
					</h2>
				</div>
				...
				<div class="mt-80 mb-20 mx-12">
					<p class="font-thin text-center py-12">
						You can now apply to jobs and receive booking requests
