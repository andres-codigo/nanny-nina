				...
				<form class="w-full" action="#" method="POST">
					<div class="mb-16">
						<div class="mb-20">
							...
							>
								We would like to a check
								<span class="text-red">*</span>
							</h5>
							<p class="font-thin mb-4">
								Please provide a reference, somebody that you
								have worked for (can also be family)that can
						...
						<div>
							<p class="font-thin">
								Please provide phone number or email address
							</p>
