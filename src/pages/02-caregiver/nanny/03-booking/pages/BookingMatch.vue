		...
		<main>
			...
			>
				<div class="flex flex-col">
					<h4
						class="font-semibold text-center text-header-four antialiased mb-1"
					>
						Woohoo!
					</h4>
					<h4
				...
				<div
					class="flex flex-col justify-center items-center mx-14 py-24"
				>
					...
					<p class="font-medium antialiased text-center pt-4">
						Let the parents know you are ready to start and will be
						on time for the booking
					</p>
				</div>
