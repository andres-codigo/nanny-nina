<template>
	<div class="w-full h-full bg-lilac-100">
		<TopNavigation backgroundColor="bg-lilac-100" :displayBorderBottom="false">
			<template #iconRight><router-link to="/dashboard?tab=2"><Img src="./assets/svg/ticks-and-crosses/cross-remove-black.svg" /></router-link></template>
		</TopNavigation>
		<main>
			<div class="flex flex-col pt-12 mx-8">
				<div class="flex flex-col">
					<h2 class="font-semibold text-center text-header-two antialiased mb-2">Your Bookings</h2>
					<p class="font-medium antialiased text-center">View your booking applications</p>
				</div>
