		...
		<main>
			<div class="h-screen flex flex-col items-center justify-center mx-4">
				<div class="grid grid-rows-3 grid-flow-col gap-0">
					...
					<div class="mt-32">
						<p class="text-white text-center font-light">Did not receive any email? Please check your spam or <a href="#" target="_self" class="text-green-600 font-light anchor-with-underline">resend link</a>.  Error singing up?  Try <a href="#" target="_self" class="text-green-600 font-light anchor-with-underline">signing up again.</a></p>
					</div>
				</div>
			</div>
		</main>
