	...
	<div class="w-full">
		...
		<main>
			<div class="flex flex-col justify-center mx-4">
				...
				<h5 class="text-left text-header-five antialiased mb-2">Get started 100% free</h5>
				...
				<h2 class="text-left text-header-two font-semibold antialiased mt-8 mb-2">Sign up as <span class="text-purple-500">Parent/Host</span></h2>
