	...
	<div class="bg-blue-500 w-full h-screen">
		...
		<main>
			<div class="min-h-full flex flex-col justify-center">
				<h2 class="mb-6 text-center text-3xl font-medium text-green-500">Check your mail</h2>
				...
				<div class="flex items-center justify-center mx-8">
					<p class="font-light text-white text-sm text-center">Did not receive any email? Please check your spam or <span class="font-light text-green-200">resend link</span>.  Error singing up?  Try <span class="font-light text-green-200">signing up again.</span></p>
				</div>
			</div>
		</main>
	</div>
