		...
		<main>
			<div class="h-full flex flex-col pt-12 mx-4">
				<form class="w-full" action="#" method="POST">
					...
					<p class="text-left text-lg font-thin antialiased">How much is your budget for this booking?</p>
					...
					<div class="mb-10">
						...
						<p class="text-center text-sm py-2"><a href="#" class="anchor-with-underline text-blue-500">Price advice</a> for Amsterdam: From &euro;10/hr</p>
					</div>
