<template>
	<div class="w-full bg-lilac-100">
		<TopNavigation backgroundColor="bg-lilac-100" :displayBorderBottom="false">
			<template #iconRight><router-link to="/dashboard?tab=3"><XIcon class="w-8 h-8 text-black" aria-hidden="true" /></router-link></template>
		</TopNavigation>
		<main>
				...
				<div class="grid grid-rows-3 grid-flow-col gap-0">
					...
					<div>
						<div class="grid grid-rows-2 gap-0">
							<div><h3 class="font-semibold text-center text-header-three antialiased mb-6">Ooops!</h3></div>
							<div><p class="text-center font-light mx-16">You have to place a new request to contact a nanny</p></div>
						</div>
					</div>
					...
					<div class="flex flex-col justify-center items-center">
						...
						-->
						<Img src="./assets/svg/illustrations/jigsaw-people-green.svg" />
					</div>
					...
					<div class="flex flex-col justify-center items-center mt-20">
						<div class="grid grid-rows-2 gap-2">
							...
							<div class="text-center mt-4">
								<AnchorTextOnly text="Learn more about Nannies >" textColorClass="anchor-black" />
							</div>
						</div>
					</div>
				</div>
