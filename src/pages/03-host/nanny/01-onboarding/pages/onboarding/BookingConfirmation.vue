<template>
	<div class="w-full bg-lilac-100">
		<TopNavigation background-color="bg-lilac-100" :hide-header="true">
			<template #iconLeft
		...
		<main>
			<div class="h-screen flex flex-col mx-8 mb-10">
				<div class="mt-16">
					<h2
						class="text-header-two text-center font-semibold antialiased"
					>
				...
				<h6 class="text-header-six inline-block mb-2">Next steps</h6>
				<ul role="list">
					<li class="py-1 flex">
						<CheckCircleIcon
						...
						<div class="ml-3">
							<p class="text-sm leading-none font-thin">
								Keep an eye on the bookings page for responses
							</p>
						</div>
					</li>
					<li class="py-1 flex">
						...
						<div class="ml-3">
							<p class="text-sm leading-none font-thin">
								We've suggested profiles, you can also invite
								more
							</p>
						</div>
					</li>
					<li class="py-1 flex">
						...
						<div class="ml-3">
							<p class="text-sm leading-none font-thin">
								Turn on notification to respond quickly
							</p>
						</div>
					</li>
				</ul>
				...
				<div class="flex flex-col justify-center items-center mt-7">
					<CheckboxLeftWithContainerAndLabelRight
						label-container-class="text-xs font-bold"
