<template>
	<div class="w-full h-full">
		<TopNavigation text="Event Booking">
			<template #iconLeft
				...
				<form class="w-full" action="#" method="POST">
					...
					<div class="mb-10">
						...
						<div class="mt-4 grid grid-cols-2 gap-x-2">
							<div>
								<SelectMenu option-text="Select an option" />
							</div>
						</div>
					</div>

					<div class="flex flex-col mb-10">
						<p class="font-thin">When is this event happening?</p>
						<div
							class="grid grid-cols-2 gap-4 gap-y-6 gap-x-2 mt-4"
						>
							<div><InputField text="Date" /></div>
							<div>&nbsp;</div>

							<div><InputField text="Start Time" /></div>
							<div><InputField text="End Time" /></div>
						</div>
					</div>
					...
					<div class="flex flex-col mb-10">
						...
						>
							Approximately, how many children do you expect?
						</h5>
						<p class="text-sm font-light">
							We recommend asking for 1 nanny per +-5 children.
							This depends on the age of the kids and the activity
							at the event. For tips / advice, please contact
					...
					<div class="mb-10">
						...
						<p class="font-thin">
							Based on total above, we advise at least 2 nannies.
						</p>
						<div class="mt-4 grid grid-cols-2 gap-x-2">
							<div>
								<SelectMenu option-text="1" classes="w-24" />
							</div>
						</div>
					</div>
					...
					<div class="mb-10">
						...
						<div class="grid grid-cols-2 gap-y-6 gap-x-2">
							<div><SelectMenu classes="mt-2" /></div>
							<div
