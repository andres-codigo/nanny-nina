		...
		<main>
			<div class="h-screen flex flex-col pt-12 mx-4">
				<form class="w-full" action="#" method="POST">
					<h5 class="text-header-five font-semibold antialiased mb-6">Booking Venue</h5>
					...
					<div class="mb-10">
						...
						<RadioQuestion
							...
							questionOneSubText="I want a childminder to come to my home. €15-€18/hr/per family"
							:questionOneSubTextHidden="false"
							questionTwoText="Childminder's home"
							questionTwoSubText="I want to leave my kids at the childminder's.€5-€10 per kid/hr"
							:questionTwoSubTextHidden="false"
							:hasThirdQuestion="true"
							questionThreeText="Both"
							questionThreeSubText="I'm flexible"
					...
					<div class="mb-10">
						...
						<p class="text-center text-sm py-2"><a href="#" target="_self" class="anchor-with-underline text-blue-500">Price advice</a> for Amsterdam: From &euro;5/kid/hr</p>
					</div>
					...
					<div class="flex mx-4 mb-4">
						<div class="basis-1/2">
							<p class="text-lg font-medium antialiased">Estimated  Cost</p>
						</div>
