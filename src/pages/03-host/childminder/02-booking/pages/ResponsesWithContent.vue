		...
		<main>
			...
			<div class="flex flex-col mx-4">
				...
				<div class="flex flex-col pb-8">
					<ResponsesCard
						classes="text-purple-900 bg-purple-50 hover:bg-lilac-100 focus:bg-lilac-200"
					...
					>
						<template #details
							><p class="text-xs text-purple-800 pt-1">
					...
					<ResponsesCard
						classes="text-purple-900 bg-melon-100 hover:bg-melon-300 focus:bg-melon-600"
						badge-class="bg-melon-50 text-purple-900"
