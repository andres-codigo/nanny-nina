<template>
	<div class="w-full h-full">
		<TopNavigation text="Intake Call">
		...
		<main>
			<div class="flex flex-col justify-center pt-12 mx-4">
				<form class="w-full" action="#" method="POST">
					...
					<div class="mb-12">
						<IntakeCallCard backgroundColor="bg-lilac-50" textColorHeader="text-purple-500" header="Next Step: Intake" />
					</div>
					...
					<div class="mb-20">
						...
						<p class="text-gray-500 mb-2">
							...
							<!--
								FYI Tjardo/Aliu
								mailto 'subject' parameter is to change depending if from Netherlands or International

								Netherlands
								"Dutch Full Service: Intake Call" if it's from the Netherlands

								International
								"English Full Service: Intake Call" if it's International
							-->
							<a href="mailto:aupair@nannynina.nl?subject=Dutch Full Service: Intake Call" class="anchor-blue anchor-with-underline">aupair@nannynina.nl</a>
						</p>
					...
					<div class="flex flex-col justify-center items-center mb-10">
						<AnchorPrimary text="Plan a call" class="w-button-xl text-xl py-4" />
					</div>
				</form>
			</div>
		</main>
