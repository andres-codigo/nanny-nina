		...
		<main>
			...
			>
				<div class="flex flex-col">
					<h4
						class="font-semibold text-center text-header-four text-green-500 antialiased mb-1"
					>
						Header Four
					</h4>
					<p
						class="font-medium antialiased text-white text-center pt-4"
					>
						Paragraph
					</p>
				</div>
				...
				<div class="flex flex-col justify-center items-center mb-10">
					<div class="grid grid-rows-2 gap-2">
						...
						<div>
							<ButtonOutlineLight
								text="Button Outline"
								classes="w-button-xl text-xl py-4 text-white border-white hover:border-lilac-400 focus:border-green-500"
							/>
						</div>
					</div>
				</div>
