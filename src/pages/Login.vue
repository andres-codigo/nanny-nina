		...
		<div class="min-h-full flex flex-col justify-center py-12 mx-10 mt-8">
			...
			<form class="" action="#" method="POST">
				...
				<div class="mt-14">
					...
					<div class="my-6">
						<button type="submit" class="w-full flex justify-center py-3 px-4 border border-transparent rounded-full shadow-sm text-lg font-medium text-white bg-indigo-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500">Login</button>
					</div>
