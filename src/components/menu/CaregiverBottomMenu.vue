	...
	<section class="fixed inset-x-0 bottom-0 z-10 block w-full bg-white border-t border-gray min-w-360-for-dev-not-prod">
		<div class="flex items-center justify-between h-20">
			...
			<BottomMenuItem to="dashboard" text="Discover" class="text-gray-400">
				<Img src="./assets/svg/menu/bottom/discover.svg" class="inline-block mb-1" />
			</BottomMenuItem>

			<BottomMenuItem to="dashboard" text="Profile" :class="[isProfileSelected ? 'text-purple-500 hover:text-purple-400 focus:text-purple-600' : 'text-gray-400']">
				<Img :src="isProfileSelected ? './assets/svg/menu/bottom/profile-selected.svg' : './assets/svg/menu/bottom/profile.svg'" class="inline-block mb-1" />
			</BottomMenuItem>
		</div>
	</section>
</template>
