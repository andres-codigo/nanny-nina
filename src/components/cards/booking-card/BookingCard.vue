		...
		>
			<div :class="['flex flex-row rounded-t-3xl', tempBackgroundColor]">
				<div class="relative grow h-64 overflow-hidden">
					<span
						:class="[
							'absolute left-4 top-8 w-24 inline-flex rounded-3xl justify-center font-semibold px-2',
			...
			<div class="h-56 mx-4">
				<div class="flex flex-row my-6">
					<div class="basis-2/3">
						...
						<p class="text-sm text-gray-500 font-thin leading-none">
							{{ timeOrDate }}
						</p>
					</div>
					<div class="basis-1/3">
				...
				<div class="flex flex-row mb-4 items-center">
					...
					<div
						v-if="isLockedMatch"
						class="inline-flex grow items-center font-thin ml-1"
					>
						2km away
						<Dot />
