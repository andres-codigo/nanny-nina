<template>
	<div class="inline-flex w-full border border-gray-50 hover:shadow-lg hover:shadow-gray-50 rounded-3xl mb-10">
		<a href="/" target="_self" class="w-full h-card-au-pair focus:opacity-60">
			<div :class="['flex flex-row rounded-t-3xl', tempBackgroundColor]">
				<div class="relative grow h-64 overflow-hidden">
					<span class="absolute right-2 top-2 w-11"><HeartIcon class="w-11 h-11 text-red" aria-hidden="true" /></span>
					<!--
						Image svg/png here
