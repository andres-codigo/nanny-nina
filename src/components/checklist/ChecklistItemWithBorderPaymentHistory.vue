<template>
	<li>
		...
		<a class="block mb-2 border border-gray-100 rounded-20px hover:rounded-20px hover:bg-lilac-50 hover:border-gray-100 focus:bg-green-100 focus:border-gray-100" href="#" target="_self">
			<div class="flex flex-row">
				<div class="basis-11/12">
					<div class="flex items-center py-6">
						...
						<div class="my-2">
							<div class="z-0">
								<p class="text-2xl text-purple-900 ">{{ header }}</p>
								<p class="text-sm font-medium">Total: <span class="text-lg font-bold"><slot name="totalAmount">&euro;185</slot></span></p>
								<p class="text-xs font-thin text-gray-500">{{ date }}</p>
							</div>
						</div>
					</div>
				</div>
...
export default {
	...
	props: {
		...
		rightSvg: {
			type: String,
			default: './assets/svg/other/chevron-right-black.svg'
		},
		header: {
			type: String,
			default: 'Sanders'
